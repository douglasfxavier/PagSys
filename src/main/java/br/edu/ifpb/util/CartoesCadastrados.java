...
public class CartoesCadastrados {
    ...
    public static List<Cartao> getLista(){
        if (lista == null){
            ...
            Cartao cartao1 = new Cartao(cliente1,"1111" , Bancos.BRASIL, Bandeiras.VISA);
            cartao1.setSenhaHash("123");
            lista.add(cartao1);

            Cliente cliente2 = new Cliente("Maria",new ContaCorrente("2020-1","23456-7"));
            Cartao cartao2 = new Cartao(cliente2,"2222" , Bancos.CAIXA, Bandeiras.VISA);
            cartao2.setSenhaHash("456");
            lista.add(cartao2);

            Cliente cliente3 = new Cliente("Pedro",new ContaCorrente("3030-2","34567-8"));
            Cartao cartao3 = new Cartao(cliente3,"3333" , Bancos.BRASIL, Bandeiras.VISA);
